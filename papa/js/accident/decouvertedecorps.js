...
function cil() {
    ...
    var heures = parseInt(corps.substring(0, 2), 10);
    var minutes = parseInt(corps.substring(3), 10);
...
function opj() {
    ...
    organismeElement.value = padZero(heures) + ":" + padZero(minutes);
    var organismeElement = document.getElementById('transbordement');
    organismeElement.value = padZero(heures) + ":" + padZero(minutes);
...
function adc() {
    ...
    // Réinsérer les nouvelles heures dans le champ de saisie de temps destination
    var organismeElement = document.getElementById('heureadc');
    organismeElement.value = padZero(heures) + ":" + padZero(minutes);
}

function pf() {
    // Récupérer la valeur de l'élément d'entrée
    var heureadc = document.getElementById("heureadc").value;

    // Extraction des heures et des minutes
    var heures = parseInt(heureadc.substring(0, 2), 10);
    var minutes = parseInt(heureadc.substring(3), 10);
    ...
    // Réinsérer les nouvelles heures dans le champ de saisie de temps destination
    var organismeElement = document.getElementById('heurepf');
    organismeElement.value = padZero(heures) + ":" + padZero(minutes);
}

function circul() {
    // Récupérer la valeur de l'élément d'entrée
    var heurepf = document.getElementById("heurepf").value;

    // Extraction des heures et des minutes
    var heures = parseInt(heurepf.substring(0, 2), 10);
    var minutes = parseInt(heurepf.substring(3), 10);
